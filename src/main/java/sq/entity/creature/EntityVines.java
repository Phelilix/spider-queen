...
public class EntityVines extends Entity
{
	...
	public void onUpdate()
	{
		...
		final Block block = worldObj.getBlock(xTile, yTile - 1, zTile);
		if(block != Blocks.air)
		{
			final Block ikk = worldObj.getBlock(xTile, yTile + 2 - 1, zTile);
			final Block ikk2 = worldObj.getBlock(xTile, yTile - 1 - 1, zTile);
			motionY = 0F;
		...
		if(movingobjectposition != null)
		{
			...
			if(movingobjectposition.entityHit != null)
			{
				...
				if(friendly)
				{
					...
					{
						final EntityMandragora m = (EntityMandragora)movingobjectposition.entityHit;
